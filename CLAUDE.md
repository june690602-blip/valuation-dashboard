...
> # ▶ 지금 할 일: **신뢰도 배지를 떼고, 문서를 지금 화면에 맞춘다**
>
> → [`docs/HANDOFF-DOCS-REVIEW.md`](docs/HANDOFF-DOCS-REVIEW.md)로 가세요.
>
> **⚠ 신뢰도 배지는 재봤더니 뜻이 반대였습니다.** '높음'은 실측 **0건**이고,
> *"덜 믿으세요"*라고 붙인 '낮음'이 세 자(1·3·5년) 모두에서 **더 잘 맞습니다**
> (IC 0.196 vs 0.185 · 간격 48.1% vs 37.7%). **떼기로 결정했습니다**(사용자 · 2026-08-12).
> 대체 지표를 즉석에서 만들지 마세요 — 사전등록이 먼저입니다.
>
> **⚠ README·사용설명서가 옛 화면을 설명하고 있습니다.** 판정이 5등급 → 3등급이 됐는데
> 문서는 *"5단계 배지 (+30%↑ 크게 저평가…)"*를 그대로 적고 있습니다. 게다가
> **사용설명서는 저장소 밖**(`투자지표/사용설명서.md`)이라 CI에 안 걸립니다.
>
...
> **다음 ADR 번호는 0043.** (0038 street-targets · 0039 rim-persistence · 0040 roe-buckets가
