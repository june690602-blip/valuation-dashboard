...
> 그 함정(주가를 늘리면 ② 밴드가 조용히 26년 밴드가 되는 것)은
> **[ADR-0026](docs/adr/0026-band-window-is-a-decision-not-a-default.md)이 이미 막았습니다** —
> 밴드 창은 이제 `BAND_WINDOW_YEARS = 7`이 정하고 `_band`가 스스로 자릅니다.
> 5년이던 예전 창도 근거 없는 기본 인자였습니다(같은 착각의 **세 번째**입니다).
>
