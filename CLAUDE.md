...
> # ▶ 지금 할 일: **D-5단계 — 판정 문턱·등급 수 재검토 (사전등록 필요)**
>
> → [`docs/HANDOFF-AXES.md`](docs/HANDOFF-AXES.md)의 **5단계**로 가세요.
> **숫자를 보기 전에 사전등록부터** 하는 단계입니다.
>
...
> 뜹니다. 삼성전자 −6.7%~+15.0%(그 안에서 판정이 갈립니다) · KB금융 −4.8%~+10.8%.
>
...
> **다음 ADR 번호는 0042.** (0038 street-targets · 0039 rim-persistence · 0040 roe-buckets가
