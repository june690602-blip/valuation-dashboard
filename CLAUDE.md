...
>
> **▶ 성능 — 첫 조회 13초는 전부 순차 네트워크 대기입니다.** 계산은 0.04초입니다.
> 실측(161890 · 13.2초): Gemini 피어분류 4.04 · DART 2.49 · 뉴스 2.38 · yfinance 재무 1.82 ·
> TTM 1.33. **서로 독립인데 한 줄로 세워져 있습니다.** 병렬로 묶으면 4.5초대(캐시 찬 종목은
> 2초대)가 됩니다. `build_peer_table`이 이미 같은 패턴(8워커)을 쓰고 `file_cache`가 키 단위
...
> **다음 ADR 번호는 0045.** (0038 street-targets · 0039 rim-persistence · 0040 roe-buckets가
