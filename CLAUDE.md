...
> **▶ 다음 작업은 '독립성 기준(상한 0.5) 재정의'입니다 — 착수 전에
> [`docs/HANDOFF-CONFIDENCE.md`](docs/HANDOFF-CONFIDENCE.md) 맨 위를 먼저 읽으세요.**
> ADR-0016 결정 3이 못박은 순서(신뢰도 산식 → EPV)가 **둘 다 끝났습니다** — ADR-0022가
> 앞의 것을, **ADR-0023이 뒤의 것을** 닫았습니다. **EPV는 짓지 않습니다**(두 시장 모두
> 검사 2 미달). 다만 그 관문의 상한 0.5를 **기존 축이 이미, EPV보다 크게 어깁니다**
> (KR ③↔① +0.780 > EPV +0.713 · US ①↔⑤ +0.762 > EPV +0.637) — 소급 적용했다면
> 기존 축도 떨어졌습니다. 그 기준을 다시 정하는 것이 다음 작업입니다.
> 361 passed, 99 subtests · CI 관문 11개 · ADR은 0023까지.
