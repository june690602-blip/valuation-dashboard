...
(function () {
  ...
  function renderResult() {
    ...
    $('result').innerHTML = '<div class="result-hero"><div class="profile-mark" aria-hidden="true">' + esc(profile.symbol) + '</div><div>' +
      ...
      '<div id="cmlWrap" style="margin-top:12px"></div><div id="modelTiles" class="model-tiles"></div><div id="modelCheck" style="font-size:11px;color:var(--ink-3);line-height:1.6;margin-top:8px"></div></div></details></section>' +
