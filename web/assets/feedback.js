...
(function () {
  ...
  var css = [
    ...
    '#fbCard .fb-lead{margin:6px 0 14px;font-size:12px;line-height:1.65;color:var(--ink-2,#514C45)}',
    '#fbCard label{display:block;font-size:11px;font-weight:600;letter-spacing:.06em;text-transform:uppercase;',
    'color:var(--ink-3,#8A847B);margin-bottom:4px}',
    '#fbText,#fbFrom{width:100%;box-sizing:border-box;border:1px solid var(--line-strong,#C8C2B4);border-radius:var(--radius-sm,2px);',
    'background:#fff;color:var(--ink,#16130F);font-family:inherit;font-size:13px;line-height:1.6;padding:8px 10px}',
    ...
    '.fb-b{border-radius:var(--radius-sm,2px);font-family:inherit;font-size:12.5px;padding:8px 14px;cursor:pointer}',
